...
export default function ProjectsPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <div className="mt-2 space-y-1.5">
            ...
            {!isUnlimited && (
              <div className="h-1.5 w-48 overflow-hidden rounded-full bg-muted/30">
                <motion.div
      ...
      {isAtLimit && (
        <motion.div
          className="mt-6 flex items-center gap-3 rounded-lg border border-amber-500/30 bg-amber-500/5 p-4"
        ...
        >
          {projects.map((project) => (
            <motion.div key={project._id} variants={fadeInUp}>
              <Link href={`/projects/${project._id}`}>
                <Card className="card-hover-glow group h-full border-border/40 transition-colors hover:border-emerald-500/30 hover:bg-card">
                  <CardContent className="p-6">
                    {/* Thumbnail placeholder */}
                    <div className="mb-4 flex h-32 items-center justify-center rounded-md bg-muted/30 border border-border/20">
          ...
          {projects.length === 0 && (
            <div className="col-span-full flex flex-col items-center justify-center py-20 text-center">
              ...
              <h3 className="mt-2 text-lg font-medium">Nenhum projeto ainda</h3>
