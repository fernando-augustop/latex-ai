...
export default function SettingsPage() {
  ...
  return (
    <motion.div
      ...
      animate="visible"
    >
      <motion.h1 variants={fadeIn} className="text-2xl font-bold mb-6">
        Configurações
      </motion.h1>
          ...
          <Card className="border-border/40">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                <Avatar className="h-16 w-16 border border-emerald-500/20">
        ...
        <motion.div variants={fadeInUp}>
          <Card className="border-border/40">
            ...
            <CardContent className="space-y-4">
              ...
              <Button
                size="sm"
                className="btn-press bg-emerald-500 text-white hover:bg-emerald-600"
              >
